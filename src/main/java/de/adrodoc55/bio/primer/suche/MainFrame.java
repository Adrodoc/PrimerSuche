...
public class MainFrame extends JFrame {
	...
	private void init() {
		...
		getContentPane().add(getColorPanel(), BorderLayout.EAST);
	...
	private JPanel getPanel() {
		if (panel == null) {
			panel = new JPanel();
			panel.add(getPrimerTextField());
			panel.add(getBtnSearch());
			panel.setBorder(new BevelBorder(BevelBorder.LOWERED));
			panel.add(getAutoSearchCheckBox());
		}
		return panel;
	}
	...
	private Component getColorPanel() {
		if (colorPanel == null) {
			...
			gbc_lblInvPrimer.anchor = GridBagConstraints.WEST;
			...
			gbc_lblCompPrimer.anchor = GridBagConstraints.WEST;
